...
public class Laiva {
    ...
    private int osumat;
    /** Montako kertaa laivaan on osuttu jos on yhtäsuurin kuin koko laiva tuhoutuu **/
    ...
    /** luo laiva-olion, jonka kooksi asetaan syötetty luku, tässä vaiheessa laiva on ehjä **/
